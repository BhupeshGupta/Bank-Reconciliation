...
// Get Bank Rules
reconApp.service('getFeedLiveBankRules', ['$http', function ($http) {
    this.liveFeed = function (bank) {
        if (!bank)
            return false;
        var snd = {
...
reconApp.service('getFeedMockBankCheckStatment', ['$http', '$q', function ($http, $q) {
    this.getFeed = function () {
        var feed = [
            {
                "bank_txn": {
...
reconApp.service('getFeedMockBankStatement', ['$http', '$q', function ($http, $q) {
    this.getFeed = function () {
        var feed = [
            {
...
reconApp.service('getFeedMockRules', ['$http', '$q', function ($http, $q) {
    this.getFeed = function () {
        var feed = [
            {
...
reconApp.service('getFeedMockBanks', ['$http', '$q', function ($http, $q) {
    this.getFeed = function () {
        var feed = [
            {
                "name": "JK Bank (CD441)"
